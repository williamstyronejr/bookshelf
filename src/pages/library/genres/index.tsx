      ...
      <div className="flex flex-col flex-nowrap md:flex-row md:flex-wrap relative w-full px-4">
        <div className="sticky md:static top-0 md:top-auto z-10">
          <input
            ...
            className="w-full sticky px-2 py-2 top-0 border-2 rounded"
            value={search}
            onChange={(evt) => {
        ...
        <div className="flex flex-col md:flex-row flex-nowrap md:flex-wrap md:w-0 flex-grow justify-center">
          {genreList
            ? genreList
                .filter(({ genre }) =>
